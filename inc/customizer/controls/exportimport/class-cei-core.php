...
define( 'CEI_PLUGIN_DIR', KINDLING_INC_DIR .'customizer/controls/exportimport/' );
define( 'CEI_PLUGIN_URL', KINDLING_INC_DIR_URI .'customizer/controls/exportimport/' );
...
final class CEI_Core {
	...
	{
		load_plugin_textdomain( 'customizer-export-import', false, false ); /* 3rd param should be .mo filepath */
	}
	...
	{
		// Register
		wp_register_script( 'cei-js', CEI_PLUGIN_URL . 'exportimport.js', array( 'jquery' ), CEI_VERSION, true );
	...
	{
		require_once CEI_PLUGIN_DIR . 'class-cei-control.php';
	...
	static private function _import( $wp_customize ) 
	{
		...
		require_once CEI_PLUGIN_DIR . 'class-cei-option.php';
