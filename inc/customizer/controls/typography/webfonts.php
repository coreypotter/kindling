 ...
 * @since 1.0.0
 */
function kindling_standard_fonts() {
	return apply_filters( 'kindling_standard_fonts_array', array(
 ...
 * @since 1.0.0
 */
function kindling_enqueue_google_font( $font ) {

	// Get list of all Google Fonts
	$google_fonts = kindling_google_fonts_array();
	...
	$weights = apply_filters( 'kindling_google_font_enqueue_weights', $weights, $font );
	$italics = apply_filters( 'kindling_google_font_enqueue_italics', true );
	...
	// Enqueue style
	wp_enqueue_style( 'kindling-google-font-'. $handle, $url, false, false, 'all' );
