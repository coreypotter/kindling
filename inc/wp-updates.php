...
new WPUpdatesThemeUpdater_1963( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );

*/


################################################################################
### Updated for Kindling but will likely be dropped for GitHub-based Updates ###
################################################################################


if( !class_exists('WPUpdatesThemeUpdater_1963') ) {
    class WPUpdatesThemeUpdater_1963 {
