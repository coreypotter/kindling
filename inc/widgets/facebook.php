...
if ( ! class_exists( 'Kindling_Facebook_Widget' ) ) {
	class Kindling_Facebook_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if ( empty( $like_args['href'] ) || ! $this->is_valid_facebook_url( $like_args['href'] ) ) {
				if ( current_user_can('edit_theme_options') ) {
					echo $before_widget;
					echo '<p>' . sprintf( esc_html__( 'It looks like your Facebook URL is incorrectly configured. Please check it in your <a href="%s">widget settings</a>.', 'kindling' ), esc_url( admin_url( 'widgets.php' ) ) ) . '</p>';
					echo $after_widget;
				}
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'href' ) ); ?>"><?php esc_html_e( 'Facebook Page URL', 'kindling' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width', 'kindling' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height', 'kindling' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'colorscheme' ) ); ?>"><?php esc_html_e( 'Color Scheme', 'kindling' ); ?></label>
