...
if ( ! class_exists( 'Kindling_Social_Widget' ) ) {
	class Kindling_Social_Widget extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"><?php esc_html_e( 'Style:', 'kindling' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'transition' ) ); ?>"><?php esc_html_e( 'Transition:', 'kindling' ); ?></label>
