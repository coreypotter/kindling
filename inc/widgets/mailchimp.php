...
if ( ! class_exists( 'Kindling_MailChimp_Widget' ) ) {
	class Kindling_MailChimp_Widget extends WP_Widget {
		...
		function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('mailchimpaction') ); ?>"><?php esc_html_e('MailChimp Form Action', 'kindling'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('width') ); ?>"><?php esc_html_e('Input Width (px)', 'kindling'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('height') ); ?>"><?php esc_html_e('Input Height (px)', 'kindling'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('placeholder') ); ?>"><?php esc_html_e('Placeholder', 'kindling'); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id('submit_text') ); ?>"><?php esc_html_e('Submit Text', 'kindling'); ?></label>
